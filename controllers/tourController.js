...
// Post a tour
exports.createTour = helpers.catchAsync(async (req, res, next) => {
...
// Update a tour
exports.updateTour = helpers.catchAsync(async (req, res, next) => {
  const { id } = req.params;
...
// Delete a tour
exports.deleteTour = helpers.catchAsync(async (req, res, next) => {
  const { id } = req.params;
